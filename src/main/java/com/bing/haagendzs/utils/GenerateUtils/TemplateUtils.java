...
public class TemplateUtils {
    ...
    // 项目源码包前缀
    static final String projectRoot = "com.bing.haagendzs.generate";
    ...
    static {
        ...
        CONFIGURATION.setTemplateLoader(new ClassTemplateLoader(com.bing.haagendzs.utils.GenerateUtils.TemplateUtils.class, "/templates"));
